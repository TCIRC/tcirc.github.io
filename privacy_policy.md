...
*   於一般瀏覽時，伺服器會自行記錄相關行徑，包括您使用連線設備的IP位址、使用時間、使用的瀏覽器、瀏覽及點選資料記錄等，做為我們增進網站服務的參考依據。創立帳號著，會蒐集使用email、姓名、學校、生日； Google 登入著，會蒐集 email、姓名、個人資料圖片、語言偏好，作為登入網站以及增進網站服務之用途。
